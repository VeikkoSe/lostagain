var HealthPrcess = function HealthPrcess() {
  "use strict";
  $traceurRuntime.defaultSuperCall(this, $HealthPrcess.prototype, arguments);
};
var $HealthPrcess = HealthPrcess;
($traceurRuntime.createClass)(HealthPrcess, {
